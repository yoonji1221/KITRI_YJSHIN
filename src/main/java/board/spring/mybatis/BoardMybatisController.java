...
import board.spring.mybatis.BoardVO;
...
//	}
	...
	public ModelAndView getBoardDetail(@RequestParam int seq, @RequestParam(required = false) String result) {
		ModelAndView mav = new ModelAndView();
	...
	public ModelAndView boardUpdate(@RequestParam int seq, @RequestParam(required = false) String result) {
		ModelAndView mav = new ModelAndView();
		BoardVO vo = service.getBoardDetail(seq);
		if(result!=null) {
